...
class PairsTrading:
    ...
    def fetch_data(self):
        ...
        s1 = yf.download(self.stock1, start=self.start_date, end=self.end_date)['Adj Close']
        s2 = yf.download(self.stock2, start=self.start_date, end=self.end_date)['Adj Close']
...
def main():
    ...
    print(f"Strategy total return: {final_return:.2%}")
